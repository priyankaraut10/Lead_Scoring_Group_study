...
- Lead scoring Case Study PriyaD,PriyaR, SandhyaK final.ipynb: The python file with code and relevant comments
- Assignment Subjective Questions.pdf: Answered subjective questions
- Lead Score Case Study.pdf: Final Presentation
- Leads.csv: Data worked on
- Leads Data Dictionary.xlsx: Data Dictionary
- SUMMARY.pdf: Summary on approach towards model building in python nb
